...
@section('container')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Absensi Mata Kuliah {{ $attendance->classroomSubject->subject->name }} | {{ $attendance->classroomSubject->classroom->name }}</h1>
    </div>
        ...
        <table class="table table-striped table-sm">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="/dashboard/attendance/{{ $userAttendance->id }}/edit" class="badge bg-warning"><span data-feather="edit"></span></a>
              </td>
            </tr>
